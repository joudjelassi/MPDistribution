...
Shader "PolyPixel/StandardHeightPOM"
{
	Properties
	{
		...
		_DetailedNormailUV("Detailed Normail UV", Float) = 0
		_DetailedNormalAmount("Detailed Normal Amount", Float) = 0
		_CompactMap("Compact Map", 2D) = "white" {}
		_Metalic("Metalic", Range( 0 , 1)) = 1
		_Smoothness("Smoothness", Range( 0 , 3)) = 0.7
		_Occlusion("Occlusion", Range( 0 , 1)) = 1
		_HeightMap("HeightMap", 2D) = "white" {}
		_Scale("Scale", Range( 0 , 1)) = 0.4247461
		_CloudMap("Cloud Map", 2D) = "white" {}
		_RainFallAmount("RainFall Amount", Float) = 0
		_AlbedoColor("Albedo Color", Color) = (0.5147059,0.5147059,0.5147059,0)
	...
	SubShader
	{
		...
		uniform float _DetailedNormailUV;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = ( lerp( UnpackScaleNormal( tex2D( _Normal,customUVs, temp_output_40_0, temp_output_41_0) ,_NormalScale ) , UnpackNormal( tex2D( _Normal,i.uv_Normal) ) , temp_output_80_0 ) + ( UnpackScaleNormal( tex2D( _DetailedNormalMap,( i.texcoord_0 * _DetailedNormailUV )) ,_DetailedNormalAmount ) * 1.0 ) );
			float4 temp_output_125_0 = ( _AlbedoColor * tex2D( _Albedo,customUVs, temp_output_40_0, temp_output_41_0) );
			o.Albedo = lerp( temp_output_125_0 , ( temp_output_125_0 * _PuddleColor ) , temp_output_80_0 ).rgb;
			float2 temp_cast_5 = 1.0;
			float4 tex2DNode23 = tex2D( _CompactMap,temp_cast_5, temp_output_40_0, temp_output_41_0);
...
/*ASEBEGIN
Version=3104
-1913;29;1906;1004;1152.095;1289.668;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;115;-1716.295,425.6315;Float;1261.6;821.1603;Detailed Normal;7;116;117;118;119;120;121;122
...
Node;AmplifyShaderEditor.CommentaryNode;55;-214.6332,-1102.902;Float;604.3202;565.9199;Albedo Settings;5;11;111;100;124;125
...
Node;AmplifyShaderEditor.TexturePropertyNode;9;-1548.999,-82.90001;Float;Property;_HeightMap;HeightMap;11;None;False;white;Auto
Node;AmplifyShaderEditor.RangedFloatNode;13;-1267.999,-4.900008;Float;Property;_Scale;Scale;12;0.4247461;0;1
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-2326.232,-942.9026;Float;Property;_RainFallAmount;RainFall Amount;14;0;0;0
Node;AmplifyShaderEditor.RangedFloatNode;67;-2317.232,-831.9026;Float;Property;_PuddleFalloff;Puddle Falloff;17;0;0;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-3036.634,-1269.502;Float;Property;_PuddleSize;Puddle Size;16;0;0;0
...
Node;AmplifyShaderEditor.SamplerNode;64;-2244.232,-1228.903;Float;Property;_CloudMap;Cloud Map;13;None;True;0;False;white;Auto;False;Object;-1;Auto;SAMPLER2D;;FLOAT2;0,0;FLOAT;1.0;FLOAT2;0,0;FLOAT2;0,0;FLOAT;1.0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1357.83,-1354.103;Float;Property;_PuddleAmount;Puddle Amount;18;0;0;3
Node;AmplifyShaderEditor.RangedFloatNode;82;397.4689,-320.903;Float;Property;_PuddleReflectionAmount;Puddle Reflection Amount;19;1;0;1
Node;AmplifyShaderEditor.RangedFloatNode;43;55.66606,301.4981;Float;Property;_Metalic;Metalic;8;1;0;1
Node;AmplifyShaderEditor.RangedFloatNode;45;49.66606,489.4982;Float;Property;_Occlusion;Occlusion;10;1;0;1
...
Node;AmplifyShaderEditor.SamplerNode;23;64.90477,116.3307;Float;Property;_CompactMap;Compact Map;7;None;True;0;False;white;Auto;False;Object;-1;Derivative;SAMPLER2D;;FLOAT2;0,0;FLOAT;1.0;FLOAT2;0,0;FLOAT2;0,0;FLOAT;1.0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;117;-1475.494,567.4314;Float;FLOAT2;0.0,0;FLOAT;0.0
Node;AmplifyShaderEditor.TextureCoordinatesNode;118;-1686.694,496.2314;Float;0;-1;FLOAT2;1,1;FLOAT2;0,0
Node;AmplifyShaderEditor.SamplerNode;120;-1231.994,631.6315;Float;Property;_DetailedNormalMap;Detailed Normal Map;4;None;True;0;True;bump;Auto;True;Object;-1;Auto;SAMPLER2D;;FLOAT2;0,0;FLOAT;1.0;FLOAT2;0,0;FLOAT2;0,0;FLOAT;1.0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;121;-765.2942,698.9315;Float;FLOAT3;0.0,0,0;FLOAT;0.0
Node;AmplifyShaderEditor.RangedFloatNode;122;-1091.294,873.9315;Float;Constant;_Default1;Default 1;18;1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;119;-1680.994,790.6315;Float;Property;_DetailedNormalAmount;Detailed Normal Amount;6;0;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;123;729.306,-88.76859;Float;FLOAT3;0.0,0,0;FLOAT3;0,0,0
Node;AmplifyShaderEditor.RangedFloatNode;116;-1683.694,691.2313;Float;Property;_DetailedNormailUV;Detailed Normail UV;5;0;0;0
Node;AmplifyShaderEditor.RangedFloatNode;44;51.66606,392.4982;Float;Property;_Smoothness;Smoothness;9;0.7;0;3
Node;AmplifyShaderEditor.ColorNode;100;-187.231,-1083.201;Float;Property;_PuddleColor;Puddle Color;15;0.5147059,0.5147059,0.5147059,0
Node;AmplifyShaderEditor.ColorNode;124;-193.0952,-920.6683;Float;Property;_AlbedoColor;Albedo Color;15;0.5147059,0.5147059,0.5147059,0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;68.90479,-856.6682;Float;COLOR;0.0,0,0,0;FLOAT4;0,0,0,0
Node;AmplifyShaderEditor.SamplerNode;11;-250.8952,-722.2692;Float;Property;_Albedo;Albedo;1;None;True;0;False;white;Auto;False;Object;-1;Derivative;SAMPLER2D;;FLOAT2;0,0;FLOAT;1.0;FLOAT2;0,0;FLOAT2;0,0;FLOAT;1.0
...
ASEEND*/
//CHKSM=350FD747BF53EB26A0349CEF7F4DB55530F1CE9C